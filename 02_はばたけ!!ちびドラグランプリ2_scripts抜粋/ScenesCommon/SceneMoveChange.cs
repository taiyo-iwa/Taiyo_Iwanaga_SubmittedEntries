...
public class SceneMoveChange : MonoBehaviour
{
    ...
    private string _changeSceneName = default;
    ...
    private void Start()
    {
        ...
        //ルール登録
        int ruleIndex = _racerRuleSO.RacerRuleIndex;
        _changeSceneName = changeSceneNames[ruleIndex];
    }
